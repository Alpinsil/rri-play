    ...
    <>
      ...
      >
        <div className="w-[193px] h-[345px] hover:scale-110 transition-all duration-200">
          {/* {error ? <p className="text-white">{error}</p> : <Image src={thumbnail} alt={id} width={170} height={273} className="rounded-xl w-[212px] h-[282px] " priority onError={handleError} onLoad={handleLoad} />} */}
